...
// ... (остальные компоненты и код App)
// Вставьте сюда полный код из предыдущего ответа, начиная с AuthPage и до конца.
// Я не буду дублировать его здесь, чтобы не делать инструкцию слишком громоздкой.
// Главное, чтобы это был код с Firebase, а не с localStorage.
// ...
